...
### Условия классификации (Random Forest, 200 деревьев глубины 15)

**Высокая усталость** (≥2 условий):
- Часы бодрствования **> 14** ч
- Принято решений **> 60**
- Сон **< 5** ч
- Error_Rate **> 0.15**

**Умеренная усталость:**
- Часы бодрствования **10-14** ч
- Принято решений **30-60**
- Сон **5-7** ч
- Error_Rate **0.05-0.15**

**Низкая усталость** (все условия):
- Часы бодрствования **< 10** ч
- Принято решений **< 30**
- Сон **≥ 7** ч
- Error_Rate **< 0.05**

> Детальный анализ математической модели, порогов деревьев, StandardScaler и примеров decision paths — в [MODELS.md](MODELS.md).
